...
export function setupGUI(water, ship) {
  ...
  floatingFolder.add(floatingInstance.variables, 'm', 0, 64000, 1).name('Mass (Kg)').onChange((value) => floatingInstance.setVariable('m', value));
  ...
  floatingFolder.add(floatingInstance.variables, 'R', 0, 1000, 1).name('Radius (Kg.m-3)').onChange((value) => floatingInstance.setVariable('R', value));
  floatingFolder.add(floatingInstance.variables, 'V', 0, 100, 1).name('Velocity (m-3)').onChange((value) => floatingInstance.setVariable('V', value));
  ...
  thrustFolder.add(ThrustForceInstance.variables, 'R3', 0, 1000, 10).name('Radius (Kg.m-3)').onChange((value) => ThrustForceInstance.setVariable('R3', value));
  thrustFolder.add(ThrustForceInstance.variables, 'RPM', 0, 1000, 10).name('RPM (Rolls per Min)').onChange((value) => ThrustForceInstance.setVariable('RPM', value));
  thrustFolder.add(ThrustForceInstance.variables, 'PR3', 0, 20, 1).name('Propeller Radius').onChange((value) => ThrustForceInstance.setVariable('PR3', value));
  thrustFolder.add(ThrustForceInstance.variables, 'LP3', 0, 7, 1).name('Long Propeller').onChange((value) => ThrustForceInstance.setVariable('LP3', value));
  ...
  airFolder.add(Frictionofair.variables, 'A2', 0, 440, 1).name('Space (m-2)').onChange((value) => Frictionofair.setVariable('A2', value));
  airFolder.add(Frictionofair.variables, 'R2', 0, 1000, 1).name('Radius (Kg.m-3)').onChange((value) => Frictionofair.setVariable('R2', value));
  airFolder.add(Frictionofair.variables, 'v2', -100, 100, 1).name('Speed (m.s-1)').onChange((value) => Frictionofair.setVariable('v2', value));
  ...
  waterFolder.add(waterFriction.variables, 'A1', 0, 160, 1).name('Space (m-2)').onChange((value) => waterFriction.setVariable('A1', value));
  waterFolder.add(waterFriction.variables, 'R1', 0, 1000, 1).name('Radius (Kg.m-3)').onChange((value) => waterFriction.setVariable('R1', value));
  waterFolder.add(waterFriction.variables, 'v1', -100, 100, 1).name('Water Speed (m.s-1)').onChange((value) => waterFriction.setVariable('v1', value));
