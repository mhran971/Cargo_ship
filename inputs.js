...
export function setupGUI(water, ship) {
  ...
  floatingFolder.add(floatingInstance.variables, 'V', 0, 64000, 1).name('Velocity (m-3)').onChange((value) => floatingInstance.setVariable('V', value));
  ...
  airFolder.add(Frictionofair.variables, 'v2', -21, 21, 1).name('Speed (m.s-1)').onChange((value) => Frictionofair.setVariable('v2', value));
  ...
  waterFolder.add(waterFriction.variables, 'v1', -7, 7, 1).name('Water Speed (m.s-1)').onChange((value) => waterFriction.setVariable('v1', value));
